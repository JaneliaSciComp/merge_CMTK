...
if(getWidth>800)
run("Size...", "width="+round(getWidth/2)+" height="+round(getHeight/2)+" depth="+round(nSlices/2)+" constrain average interpolation=Bicubic");
...
if(UseMask==false){// make template brighter
	...
	run("Enhance Contrast", "saturated=4");
...
print("detected sampMin; "+minSample+"  samp adjusted min"+min+"   detected sampMax; "+maxSample+"   adjusted samp max; "+max);
